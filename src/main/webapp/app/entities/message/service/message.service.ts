...
export class MessageService {
  ...
  protected convertDateFromClient(message: IMessage): IMessage {
    return Object.assign({}, message, {
      createdDate: message.createdDate?.isValid() ? message.createdDate.toJSON() : undefined,
      lastModifiedDate: message.lastModifiedDate?.isValid() ? message.lastModifiedDate.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((message: IMessage) => {
        message.createdDate = message.createdDate ? dayjs(message.createdDate) : undefined;
        message.lastModifiedDate = message.lastModifiedDate ? dayjs(message.lastModifiedDate) : undefined;
      });
    }
    return res;
  }
